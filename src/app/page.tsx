    ...
    <main className="overflow-x-clip">
      <section className="">
        ...
        <section id="home" className="relative xl:mb-20 flex flex-col justify-center">
          <div className="absolute blur-[600px] contrast-10 bg-p_orange/40 p-96 -z-10 -left-72 -top-56" />
          <div className="absolute blur-[600px] contrast-10 bg-p_green-500/40 p-96 -z-10 -right-72 -top-56" />
          <Hero />
        </section>
      </section>
      ...
      {/* Growing Together */}
      <section id="growing" className="relative flex justify-center mt-10 md:mt-20">
        <Growing />
      </section>
